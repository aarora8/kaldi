...
def get_enhancer(
    ...
    session_to_audio_paths = dict()
    session_to_audio_paths['LKC2'] = '/export/c06/aarora8/kaldi/egs/chime6/s5e_track1/LKC_S2/LKC2.wav'
    print(" session_to_audio_paths is ",session_to_audio_paths)
    if session_to_audio_paths is None:
        ...
        print('entering NotImplementedError')
